...
function Areas() {
  ...
  return (
    <main className="text-white bg-[url('/still-life-with-scales-justice-2.png')] bg-cover bg-center p-16 flex flex-col gap-10 absolute w-full z-40 max-[1350px]:pr-64 max-[1350px]:pl-4 max-[1024px]:pr-4">
      <Navbar />
      ...
      <motion.div ref={ref2} initial={{ opacity: 0, x: -150 }} animate={isInView2 ? { opacity: 1, x: 0 } : { opacity: 0, x: -150 }} transition={{ duration: 0.5, delay: 0.5 }} className="max-w-[1000px] text-justify flex flex-col gap-5 mt-14">
        ...
        <ul className="flex flex-col gap-5 pb-32 text-lg max-lg:text-base ">
          <li>
            ...
            <p className="font-light opacity-85">Direito Trabalhista Ofereço consultoria preventiva para empresas, elaborando contratos e estratégias para reduzir passivos trabalhistas, evitando litígios. Também defendo trabalhadores em questões como demissões sem justa causa, indenizações e salários atrasados, sempre buscando a melhor solução com ética e transparência.</p>
          </li>
          <li>
            <h2 className="font-extrabold">Direito Civil</h2>
            <p className="font-light opacity-85">Atuo em contratos, indenizações e disputas sobre direitos de propriedade, buscando proteger seus interesses. Tenho experiência em questões de sucessões, heranças e disputas patrimoniais, oferecendo suporte jurídico completo, seja por meio de acordo ou litígios.</p>
          </li>
          <li>
            <h2 className="font-extrabold">Direito Empresarial</h2>
            <p className="font-light opacity-85">Especializo-me em consultoria jurídica para pequenas e médias empresas, ajudando a estruturar negócios e garantir a conformidade legal. Ofereço suporte em planejamento societário e questões tributárias, com foco em reduzir riscos e impulsionar o crescimento sustentável da empresa.</p>
          </li>
          <li>
            <h2 className="font-extrabold">Direito do Consumidor</h2>
            <p className="font-light opacity-85">Defendo consumidores e fornecedores em conflitos comerciais, como produtos defeituosos e vendas indevidas. Também oriento empresas para que cumpram as normas de defesa do consumidor, sempre buscando soluções rápidas e justas.</p>
          </li>
          <li>
          ...
          <li>
            ...
            <p className="font-light opacity-85">Ofereço consultoria e acompanhamento em processos de aposentadoria, auxílio-doença e revisão de benefícios junto ao INSS, garantindo que você tenha acesso aos direitos que lhe são devidos com a melhor estratégia possível.</p>
          </li>
        </ul>
      </motion.div>
    </main>
