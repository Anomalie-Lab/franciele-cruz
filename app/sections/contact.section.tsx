...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="bg-[url('/view-ancient-greek-bust-figure.png')] bg-cover	section pb-32 pl-52 text-white max-[1450px]:pl-4 px-4 h-screen" data-section="contact">
