    ...
    <section className="bg-[url('/still-life-with-scales-justice.png')] pb-32 bg-cover bg-top section pl-52 text-white max-[1450px]:pl-4 px-4" data-section="skills">
      ...
      <motion.div ref={ref} initial={{ opacity: 0, x: 150 }} animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 150 }} transition={{ duration: 0.5, delay: 0.5 }}>
        <div>
          ...
          <p className="mt-8 w-2/4 font-base opacity-70 max-lg:w-fit max-md:text-sm">Como advogada, ofereço soluções jurídicas personalizadas, focadas em resolver os desafios legais de meus clientes com agilidade e eficiência.</p>
        </div>
              ...
              <SplideSlide>
                ...
                <ul className="grid grid-cols-2 max-w-[900px] w-full h-[600px] mt-10 max-md:h-[300px]">
                  <li className="flex text-accentSecondary justify-between px-9 max-md:px-3 max-md:py-5 py-12 flex-col h-full w-full border-t border-x">
                    ...
                    <h3 className="text-xl font-semibold text-white tracking-widest max-md:text-sm max-md:max-w-36">Direito Trabalhista</h3>
                  </li>
                  <li className="flex text-accentSecondary justify-between px-9 max-md:px-3 max-md:py-5 py-12 flex-col h-full w-full border-t border-r">
                    ...
                    <h3 className="text-xl font-semibold text-white tracking-widest max-md:text-sm max-md:max-w-36">Direito Consumidor</h3>
                  </li>
                  <li className="flex text-accentSecondary justify-between px-9 max-md:px-3 max-md:py-5 py-12 flex-col h-full w-full border">
                    ...
                    <h3 className="text-xl font-semibold text-white tracking-widest max-md:text-sm max-md:max-w-36">Direito Civil</h3>
                  </li>
                  <li className="flex text-accentSecondary justify-between px-9 max-md:px-3 max-md:py-5 py-12 flex-col h-full w-full border-y border-r">
                    ...
                    <h3 className="text-xl font-semibold text-white tracking-widest max-md:text-sm max-md:max-w-36">Direito Empresarial</h3>
                  </li>
                </ul>
              </SplideSlide>
              <SplideSlide>
                <ul className="grid grid-rows-2 max-w-[900px] w-full h-[600px] mt-10 max-md:h-[300px]">
                  <li className="flex text-accentSecondary justify-between px-9 max-md:px-3 max-md:py-5 py-12 flex-col h-full w-full border-t border-x">
                    ...
                    <h3 className="text-xl font-semibold text-white tracking-widest max-md:text-sm max-md:max-w-36">Direito Da Familia</h3>
                  </li>
                  <li className="flex text-accentSecondary justify-between px-9 max-md:px-3 max-md:py-5 py-12 flex-col h-full w-full border-y border-x">
                    ...
                    <h3 className="text-xl font-semibold text-white tracking-widest max-md:text-sm max-md:max-w-36">Direito Previdenciário</h3>
                  </li>
                </ul>
              </SplideSlide>
            </SplideTrack>
            <div className="flex justify-between items-center absolute -bottom-20 w-full">
              ...
              <div className="font-semibold text-lg cta hover-effect">
                <Link href="/areas" className="border-none bg-none cursor-pointer">
                  <span className="hover-underline-animation relative pb-2 tracking-widest flex gap-3 items-center font-base text-base max-md:text-xs">
