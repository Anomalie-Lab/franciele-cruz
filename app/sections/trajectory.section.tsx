...
export function TrajectorySection() {
  return (
    <section className="bg-black/40 pt-32 section pl-52 text-white" data-section="services">
      <TitleSection number="02" title="Trajetoria" bg="bg-white" color="text-white" />
      <div className="">
        <div>
